<x-default>
    ...
    <div class="page-header page-header-bordered">
        <h1 class="page-title">MLFF Gate Listed</h1>
        <div class="page-header-actions">
            <a href="{{ route('geomlff_create_index') }}" class="btn btn-sm btn-outline btn-primary btn-round waves-effect waves-classic">
    ...
    <script>
        ...
        $.get("{{ route('geomlff_list_js') }}", function(res) {
            console.log(res)
