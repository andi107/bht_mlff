...
<script src="{{ asset('global/js/Section/Menubar.js')}}"></script>
<script src="{{ asset('global/js/Section/GridMenu.js')}}"></script>
<script src="{{ asset('global/js/Section/Sidebar.js')}}"></script>
<script src="{{ asset('global/js/Section/PageAside.js')}}"></script>
<script src="{{ asset('global/js/Plugin/menu.js')}}"></script>

<script src="{{ asset('global/js/config/colors.js')}}"></script>
{{-- <script src="{{ asset('global/js/config/tour.js')}}"></script> --}}
...
<!-- Page -->
<script src="{{ asset('global/Site.js')}}"></script>
